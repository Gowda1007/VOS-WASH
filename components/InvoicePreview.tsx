      ...
      <div id="invoice-preview-content" className="relative w-full max-w-3xl mx-auto bg-white text-gray-800 shadow-lg font-sans aspect-[1/1.414] overflow-hidden flex flex-col p-[2cm] text-[8pt]">
        ...
        <div className="flex-grow">
          ...
          <section className="flex justify-between items-start mb-6 text-[8pt]">
            ...
            <div className="text-right">
              ...
              <div className="mt-1 pt-1 border-t border-dashed">
                <p className="font-semibold text-gray-700 text-[7pt]">Uttarahalli, Bengaluru - 61</p>
                <p className="text-gray-600 text-[7pt]">+919845418725 / 6363178431</p>
              </div>
            </div>
          </section>
          ...
          <section className="flex justify-end mt-4">
              <div className="w-full max-w-[250px] text-[8pt] space-y-1">
                  ...
                  <div className="flex justify-between border-b border-dashed pb-1"><span>Discount (Equal to GST):</span> <span>- ₹{discount.toFixed(2)}</span></div>
                  
                  <div className="flex justify-between font-bold text-sm pt-1 border-b-2 border-dashed border-gray-400 pb-1">
                      <span className="text-blue-700">NEW SERVICE TOTAL:</span>
                      <span className="text-blue-700">₹{serviceTotal.toFixed(2)}</span>
                  </div>
                  
                  {oldBalance && oldBalance.amount > 0 && <div className="flex justify-between pt-1"><span>Old Balance (Arrears):</span> <span>+ ₹{oldBalance.amount.toFixed(2)} {formatDateForDisplay(oldBalance.date)}</span></div>}
                  ...
                  <div className="border-t-2 border-dashed border-gray-400 mt-2 pt-2">
                       <div className="bg-blue-100 dark:bg-blue-900/50 rounded-md p-2 flex justify-between items-center font-bold text-lg text-blue-800 dark:text-blue-300">
        ...
        {/* Footer */}
        <footer className="w-full text-center text-[7pt] text-gray-500 pt-2">
             <hr className="mb-2"/>
