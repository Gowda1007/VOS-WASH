...
import vosLogo from '@/assets/vos-logo.png';
import sriVariLogo from '@/assets/sri-vari.png';

// --- Logo Component ---
export const Logo: React.FC<{ className?: string }> = ({ className = 'w-12 h-12' }) => (<img alt="VOS WASH Logo" src={vosLogo} className={className}/>);
// --- Vari Image Component ---
export const Vari: React.FC<{ className?: string }> = ({ className = 'w-28' }) => (
    <img alt="Sri Vari" src={sriVariLogo} className={className}/>);
