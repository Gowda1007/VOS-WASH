...
export interface PdfAdapter {
	...
	/**
	 * Generate temporary PDF for sharing (does NOT save to permanent storage)
	 * @param options Invoice data and company information
	 * @returns PDF result with temporary file path for sharing
	 */
	generateInvoicePdfForSharing?(options: PdfGenerationOptions): Promise<PdfResult>;
